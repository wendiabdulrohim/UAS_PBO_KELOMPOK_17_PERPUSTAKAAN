...
public class data_pengembalian extends javax.swing.JFrame {
    ...
    private void IDOtomatis()
    {
        try 
        {
             Connection dbkon=databasekoneksi.koneksiDb();
             Statement st=dbkon.createStatement();
             String sql_id="SELECT * FROM pengembalian order by id desc";
    ...
    public void update()
    {
        try 
        {
            ...
            String sql_update="UPDATE pengembalian set nim_anggota='"
                    +"',nim_anggota='"+NIM.getSelectedItem()
                    +"',nama_anggota='"+NAMA.getSelectedItem()
                    +"',judul_buku='"+JUDUL.getSelectedItem()
                    +"',tanggal_pengembalian='"+TANGGALPENGEMBALIAN.getText()
                    +"'WHERE id='"+ID.getText()+"'";
    ...
    private void delete()
    {
        try
        {
            Connection dbkon=databasekoneksi.koneksiDb();
            Statement st=dbkon.createStatement();
            String sql_delete="DELETE from pengembalian WHERE "
                    +"id='"+ID.getText()+"'";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("KELOLA DATA PENGEMBALIAN PERPUSTAKAAN");
        ...
        TANGGALPENGEMBALIAN.setFont(new java.awt.Font("Clarendon Blk BT", 0, 18)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(JUDUL, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(TANGGALPENGEMBALIAN, javax.swing.GroupLayout.PREFERRED_SIZE, 424, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(30, 30, 30)
